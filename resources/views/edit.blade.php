                ...
                <div class="p-5 bg-light rounded col-8">
                    ...
                    <form action="" >
                        ...
                        <div class="form-group mt-3 mb-2">
                            ...
                            <input type="text" name="editedTask" id="editedTask" class="form-control-lg mt-2 col-12" style="display:block" value="{{$task->task}}"/>
                        </div>
                        <input style="display:none" type="number" name="editId" value="{{$task->id}}">
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-success mt-3" value="Edit" onclick="editTask({{$task->id}})">Submit</button>
